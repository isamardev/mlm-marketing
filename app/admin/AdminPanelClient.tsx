        ...
        <div className="flex min-w-0 items-center justify-between gap-3">
          <div className="flex min-w-0 items-center gap-3">
            ...
            >
              ...
              <div className="flex min-w-0 items-center gap-3">
                <img src="/logo.jpeg" alt="Digital Community Magnet" className="h-8 max-h-12 w-auto max-w-[min(100%,320px)] object-contain object-left rounded-md ring-1 ring-ring" />
              </div>
          </div>
